...
# New Nations Might Also Sign Peace Security Clause. Arthur King Can”. into words, and
# extract the first letter from the 1st, 5th, 6th, 7th, 8th, 9th, 15th, 16th, 19th words and
# the first two letters from the other words. Create an associative array (dictionary object or mapping object) 
